public class Main {
    ...
    //sure it has different elements to work, or just chose multiple
    //websites)
    //• Make sure to implement all the selenium classes and
    //methods that we studied
    //1.WebDriver (including installing it and creating an
    //instance)
    //2.Opening browser and navigating to a website (include
    //all navigate options)
    ...
    //worked
    //6.Copy a paragraph form any Wikipedia article into a file
